...
/**
 * Tipo especial de celda por donde puede pasar Pacman. Cada pasillo es el nodo
 * de un grafo, pues mantiene conexiones a los pasillos vecinos.
 *
 * @author blackzafiro
 */
public class Pasillo extends Celda {
    ...
    /**
     * Además de la figura que representa el fondo de esta celda, un pasillo
     * puede tener comida encima.
     *
     * @param comida
     */
    ...
    /**
     * Además de la figura que representa el fondo de esta celda, un pasillo
     * puede tener un personaje en él.
     *
    ...
    /**
     * Devuelve verdadero si el pasillo estaba vacío y pudo recibir al
     * personaje, falso si ya había alguien ahí.
     *
     * @param personaje
     * @return
     */
    ...
    public synchronized void despidePersonaje(Personaje p) {
        if (this.personaje == null) {
            throw new IllegalStateException("No había nadie aquí.");
        }
    ...
    /**
     * Si este pasillo tenía comida la devuelve, si no devuelve
     * <code>null</code>. Si había comida la elimina de este nodo.
     *
     * @return la comida.
     */
