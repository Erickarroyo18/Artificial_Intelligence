...
/**
 * Programa para mostrar el arbol de búsqueda en el juego del gato utilizando
 * BFS.
 *
 * @author varriola
 */
public class Gatos extends PApplet {
    ...
    /**
     * Recorre la imagen para ver otras areas
     */
    ...
    protected void generaSiguienteNivel() {
        ...
        for (int i = 0; i < numGatos; i++) {
            ...
            //System.out.println(String.format("[Numero de sucesores %d]", sucesores.size()));
            if (sucesores != null) {
